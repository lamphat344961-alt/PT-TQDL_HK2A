...
dulieu <- dulieu[,colMeans (is.na(dulieu)) < 0.8]
...
#pmm (Predictive Mean Matching) giúp giá trị điền vào nằm trong khoảng thực tế của dữ liệu
# (ví dụ không tạo ra chỉ số Kali âm)
